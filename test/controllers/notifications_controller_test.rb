...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference('Notification.count') do
      post notifications_url, params: { notification: { dismissed: @notification.dismissed, level: @notification.level, status: @notification.status } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { dismissed: @notification.dismissed, level: @notification.level, status: @notification.status } }
