...
class StatusesTest < ApplicationSystemTestCase
  ...
  test "creating a Status" do
    ...
    fill_in "Air humidity", with: @status.air_humidity
    fill_in "Carbon monoxide", with: @status.carbon_monoxide
    fill_in "Collected at", with: @status.collected_at
    fill_in "Device", with: @status.device_id
    fill_in "Health status", with: @status.health_status
    fill_in "Temperature", with: @status.temperature
